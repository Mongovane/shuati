    ...
    <div v-else-if="view==='bank'">
      ...
      <div class="bank-toolbar">
        <div class="tb-left">
          ...
          <button class="btn subtle bank-sel-all-match" v-if="bank.total>bank.items.length" :disabled="busyOps.bankSelectAllMatching" @click="bankSelectAllMatching" title="跨页选中当前筛选条件下的全部题（只拉 id，不会把带插图的题干整批下载）"><span v-if="busyOps.bankSelectAllMatching" class="spin"></span>全选全部匹配 ({{ bank.total }})</button>
