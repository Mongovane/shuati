...
const CORE = [
  ...
  './css/style.css?v=51',
  './js/constants.js?v=51',
  './js/components/rich-text.js?v=51',
  './js/components/question-card.js?v=51',
  './js/api.js?v=51',
  './js/components/reader.js?v=51',
  './js/views/practice.js?v=51',
  './js/views/bank.js?v=51',
  './js/views/mock-stats.js?v=51',
  './js/views/ingest.js?v=51',
  './js/views/mineru.js?v=51',
  './js/views/books.js?v=51',
  './js/views/settings.js?v=51',
  './js/tpl/shell-open.js?v=51',
  './js/tpl/view-practice.js?v=51',
  './js/tpl/view-books.js?v=51',
  './js/tpl/view-mock.js?v=51',
  './js/tpl/view-bank.js?v=51',
  './js/tpl/view-stats.js?v=51',
  './js/tpl/view-ingest.js?v=51',
  './js/tpl/view-settings.js?v=51',
  './js/tpl/shell-close.js?v=51',
  './js/app-template.js?v=51',
  './js/app.js?v=51',
