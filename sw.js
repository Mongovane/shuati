...
const CORE = [
  ...
  './css/style.css?v=70',
  './js/constants.js?v=70',
  './js/components/rich-text.js?v=70',
  './js/components/question-card.js?v=70',
  './js/api.js?v=70',
  './js/components/reader.js?v=70',
  './js/views/practice.js?v=70',
  './js/views/bank.js?v=70',
  './js/views/mock-stats.js?v=70',
  './js/views/ingest.js?v=70',
  './js/views/mineru.js?v=70',
  './js/views/books.js?v=70',
  './js/views/settings.js?v=70',
  './js/tpl/shell-open.js?v=70',
  './js/tpl/view-practice.js?v=70',
  './js/tpl/view-books.js?v=70',
  './js/tpl/view-mock.js?v=70',
  './js/tpl/view-bank.js?v=70',
  './js/tpl/view-stats.js?v=70',
  './js/tpl/view-ingest.js?v=70',
  './js/tpl/view-settings.js?v=70',
  './js/tpl/shell-close.js?v=70',
  './js/app-template.js?v=70',
  './js/app.js?v=70',
