...
const CORE = [
  ...
  './css/style.css?v=91',
  './js/constants.js?v=91',
  './js/components/rich-text.js?v=91',
  './js/components/question-card.js?v=91',
  './js/api.js?v=91',
  './js/components/reader.js?v=91',
  './js/views/practice.js?v=91',
  './js/views/bank.js?v=91',
  './js/views/saved.js?v=91',
  './js/views/mock-stats.js?v=91',
  './js/views/ingest.js?v=91',
  './js/views/mineru.js?v=91',
  './js/views/books.js?v=91',
  './js/views/settings.js?v=91',
  './js/tpl/shell-open.js?v=91',
  './js/tpl/view-practice.js?v=91',
  './js/tpl/view-books.js?v=91',
  './js/tpl/view-mock.js?v=91',
  './js/tpl/view-bank.js?v=91',
  './js/tpl/view-stats.js?v=91',
  './js/tpl/view-ingest.js?v=91',
  './js/tpl/view-settings.js?v=91',
  './js/tpl/shell-close.js?v=91',
  './js/app-template.js?v=91',
  './js/app.js?v=91',
