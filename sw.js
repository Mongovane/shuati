...
const CORE = [
  ...
  './css/style.css?v=35',
  './js/constants.js?v=35',
  './js/components/rich-text.js?v=35',
  './js/components/question-card.js?v=35',
  './js/api.js?v=35',
  './js/components/reader.js?v=35',
  './js/views/practice.js?v=35',
  './js/views/bank.js?v=35',
  './js/views/mock-stats.js?v=35',
  './js/views/ingest.js?v=35',
  './js/views/mineru.js?v=35',
  './js/views/books.js?v=35',
  './js/views/settings.js?v=35',
  './js/app-template.js?v=35',
  './js/app.js?v=35',
