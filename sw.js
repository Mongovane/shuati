...
const CORE = [
  ...
  './css/style.css?v=27',
  './js/constants.js?v=27',
  './js/components/rich-text.js?v=27',
  './js/components/question-card.js?v=27',
  './js/api.js?v=27',
  './js/components/reader.js?v=27',
  './js/views/practice.js?v=27',
  './js/views/bank.js?v=27',
  './js/views/mock-stats.js?v=27',
  './js/views/ingest.js?v=27',
  './js/views/mineru.js?v=27',
  './js/views/books.js?v=27',
  './js/views/settings.js?v=27',
  './js/app-template.js?v=27',
  './js/app.js?v=27',
