...
const CORE = [
  ...
  './css/style.css?v=74',
  './js/constants.js?v=74',
  './js/components/rich-text.js?v=74',
  './js/components/question-card.js?v=74',
  './js/api.js?v=74',
  './js/components/reader.js?v=74',
  './js/views/practice.js?v=74',
  './js/views/bank.js?v=74',
  './js/views/mock-stats.js?v=74',
  './js/views/ingest.js?v=74',
  './js/views/mineru.js?v=74',
  './js/views/books.js?v=74',
  './js/views/settings.js?v=74',
  './js/tpl/shell-open.js?v=74',
  './js/tpl/view-practice.js?v=74',
  './js/tpl/view-books.js?v=74',
  './js/tpl/view-mock.js?v=74',
  './js/tpl/view-bank.js?v=74',
  './js/tpl/view-stats.js?v=74',
  './js/tpl/view-ingest.js?v=74',
  './js/tpl/view-settings.js?v=74',
  './js/tpl/shell-close.js?v=74',
  './js/app-template.js?v=74',
  './js/app.js?v=74',
