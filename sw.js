...
const CORE = [
  ...
  './css/style.css?v=31',
  './js/constants.js?v=31',
  './js/components/rich-text.js?v=31',
  './js/components/question-card.js?v=31',
  './js/api.js?v=31',
  './js/components/reader.js?v=31',
  './js/views/practice.js?v=31',
  './js/views/bank.js?v=31',
  './js/views/mock-stats.js?v=31',
  './js/views/ingest.js?v=31',
  './js/views/mineru.js?v=31',
  './js/views/books.js?v=31',
  './js/views/settings.js?v=31',
  './js/app-template.js?v=31',
  './js/app.js?v=31',
