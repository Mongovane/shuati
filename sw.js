...
const CORE = [
  ...
  './css/style.css?v=34',
  './js/constants.js?v=34',
  './js/components/rich-text.js?v=34',
  './js/components/question-card.js?v=34',
  './js/api.js?v=34',
  './js/components/reader.js?v=34',
  './js/views/practice.js?v=34',
  './js/views/bank.js?v=34',
  './js/views/mock-stats.js?v=34',
  './js/views/ingest.js?v=34',
  './js/views/mineru.js?v=34',
  './js/views/books.js?v=34',
  './js/views/settings.js?v=34',
  './js/app-template.js?v=34',
  './js/app.js?v=34',
