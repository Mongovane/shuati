...
const CORE = [
  ...
  './css/style.css?v=55',
  './js/constants.js?v=55',
  './js/components/rich-text.js?v=55',
  './js/components/question-card.js?v=55',
  './js/api.js?v=55',
  './js/components/reader.js?v=55',
  './js/views/practice.js?v=55',
  './js/views/bank.js?v=55',
  './js/views/mock-stats.js?v=55',
  './js/views/ingest.js?v=55',
  './js/views/mineru.js?v=55',
  './js/views/books.js?v=55',
  './js/views/settings.js?v=55',
  './js/tpl/shell-open.js?v=55',
  './js/tpl/view-practice.js?v=55',
  './js/tpl/view-books.js?v=55',
  './js/tpl/view-mock.js?v=55',
  './js/tpl/view-bank.js?v=55',
  './js/tpl/view-stats.js?v=55',
  './js/tpl/view-ingest.js?v=55',
  './js/tpl/view-settings.js?v=55',
  './js/tpl/shell-close.js?v=55',
  './js/app-template.js?v=55',
  './js/app.js?v=55',
