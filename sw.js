...
const CORE = [
  ...
  './js/components/rich-text.js?v=18',
  './js/components/question-card.js?v=18',
  './js/api.js?v=18',
  './js/components/reader.js?v=18',
  './js/views/practice.js?v=18',
  './js/views/bank.js?v=18',
  './js/views/mock-stats.js?v=18',
  './js/views/ingest.js?v=18',
  './js/views/mineru.js?v=18',
  './js/views/books.js?v=18',
  './js/views/settings.js?v=18',
  './js/app-template.js?v=18',
  './js/app.js?v=18',
