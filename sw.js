...
const CORE = [
  ...
  './js/components/rich-text.js?v=90',
  './js/components/question-card.js?v=90',
  './js/api.js?v=90',
  './js/components/reader.js?v=90',
  './js/views/practice.js?v=90',
  './js/views/bank.js?v=90',
  './js/views/saved.js?v=90',
  './js/views/mock-stats.js?v=90',
  './js/views/ingest.js?v=90',
  './js/views/mineru.js?v=90',
  './js/views/books.js?v=90',
  './js/views/settings.js?v=90',
  './js/tpl/shell-open.js?v=90',
  './js/tpl/view-practice.js?v=90',
  './js/tpl/view-books.js?v=90',
  './js/tpl/view-mock.js?v=90',
  './js/tpl/view-bank.js?v=90',
  './js/tpl/view-stats.js?v=90',
  './js/tpl/view-ingest.js?v=90',
  './js/tpl/view-settings.js?v=90',
  './js/tpl/shell-close.js?v=90',
  './js/app-template.js?v=90',
  './js/app.js?v=90',
