...
const CORE = [
  ...
  './css/style.css?v=11',
  './js/constants.js?v=11',
  './js/components/rich-text.js?v=11',
  './js/components/question-card.js?v=11',
  './js/api.js?v=11',
  './js/components/reader.js?v=11',
  './js/views/practice.js?v=11',
  './js/views/bank.js?v=11',
  './js/views/mock-stats.js?v=11',
  './js/views/ingest.js?v=11',
  './js/views/mineru.js?v=11',
  './js/views/books.js?v=11',
  './js/views/settings.js?v=11',
  './js/app-template.js?v=11',
  './js/app.js?v=11',
