...
const CORE = [
  ...
  './js/components/rich-text.js?v=88',
  './js/components/question-card.js?v=88',
  './js/api.js?v=88',
  './js/components/reader.js?v=88',
  './js/views/practice.js?v=88',
  './js/views/bank.js?v=88',
  './js/views/saved.js?v=88',
  './js/views/mock-stats.js?v=88',
  './js/views/ingest.js?v=88',
  './js/views/mineru.js?v=88',
  './js/views/books.js?v=88',
  './js/views/settings.js?v=88',
  './js/tpl/shell-open.js?v=88',
  './js/tpl/view-practice.js?v=88',
  './js/tpl/view-books.js?v=88',
  './js/tpl/view-mock.js?v=88',
  './js/tpl/view-bank.js?v=88',
  './js/tpl/view-stats.js?v=88',
  './js/tpl/view-ingest.js?v=88',
  './js/tpl/view-settings.js?v=88',
  './js/tpl/shell-close.js?v=88',
  './js/app-template.js?v=88',
  './js/app.js?v=88',
