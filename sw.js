...
const CORE = [
  ...
  './css/style.css?v=65',
  './js/constants.js?v=65',
  './js/components/rich-text.js?v=65',
  './js/components/question-card.js?v=65',
  './js/api.js?v=65',
  './js/components/reader.js?v=65',
  './js/views/practice.js?v=65',
  './js/views/bank.js?v=65',
  './js/views/mock-stats.js?v=65',
  './js/views/ingest.js?v=65',
  './js/views/mineru.js?v=65',
  './js/views/books.js?v=65',
  './js/views/settings.js?v=65',
  './js/tpl/shell-open.js?v=65',
  './js/tpl/view-practice.js?v=65',
  './js/tpl/view-books.js?v=65',
  './js/tpl/view-mock.js?v=65',
  './js/tpl/view-bank.js?v=65',
  './js/tpl/view-stats.js?v=65',
  './js/tpl/view-ingest.js?v=65',
  './js/tpl/view-settings.js?v=65',
  './js/tpl/shell-close.js?v=65',
  './js/app-template.js?v=65',
  './js/app.js?v=65',
