...
const CORE = [
  ...
  './css/style.css?v=67',
  './js/constants.js?v=67',
  './js/components/rich-text.js?v=67',
  './js/components/question-card.js?v=67',
  './js/api.js?v=67',
  './js/components/reader.js?v=67',
  './js/views/practice.js?v=67',
  './js/views/bank.js?v=67',
  './js/views/mock-stats.js?v=67',
  './js/views/ingest.js?v=67',
  './js/views/mineru.js?v=67',
  './js/views/books.js?v=67',
  './js/views/settings.js?v=67',
  './js/tpl/shell-open.js?v=67',
  './js/tpl/view-practice.js?v=67',
  './js/tpl/view-books.js?v=67',
  './js/tpl/view-mock.js?v=67',
  './js/tpl/view-bank.js?v=67',
  './js/tpl/view-stats.js?v=67',
  './js/tpl/view-ingest.js?v=67',
  './js/tpl/view-settings.js?v=67',
  './js/tpl/shell-close.js?v=67',
  './js/app-template.js?v=67',
  './js/app.js?v=67',
