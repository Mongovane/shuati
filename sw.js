...
const CORE = [
  ...
  './css/style.css?v=71',
  './js/constants.js?v=71',
  './js/components/rich-text.js?v=71',
  './js/components/question-card.js?v=71',
  './js/api.js?v=71',
  './js/components/reader.js?v=71',
  './js/views/practice.js?v=71',
  './js/views/bank.js?v=71',
  './js/views/mock-stats.js?v=71',
  './js/views/ingest.js?v=71',
  './js/views/mineru.js?v=71',
  './js/views/books.js?v=71',
  './js/views/settings.js?v=71',
  './js/tpl/shell-open.js?v=71',
  './js/tpl/view-practice.js?v=71',
  './js/tpl/view-books.js?v=71',
  './js/tpl/view-mock.js?v=71',
  './js/tpl/view-bank.js?v=71',
  './js/tpl/view-stats.js?v=71',
  './js/tpl/view-ingest.js?v=71',
  './js/tpl/view-settings.js?v=71',
  './js/tpl/shell-close.js?v=71',
  './js/app-template.js?v=71',
  './js/app.js?v=71',
