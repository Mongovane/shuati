...
const CORE = [
  ...
  './css/style.css?v=62',
  './js/constants.js?v=62',
  './js/components/rich-text.js?v=62',
  './js/components/question-card.js?v=62',
  './js/api.js?v=62',
  './js/components/reader.js?v=62',
  './js/views/practice.js?v=62',
  './js/views/bank.js?v=62',
  './js/views/mock-stats.js?v=62',
  './js/views/ingest.js?v=62',
  './js/views/mineru.js?v=62',
  './js/views/books.js?v=62',
  './js/views/settings.js?v=62',
  './js/tpl/shell-open.js?v=62',
  './js/tpl/view-practice.js?v=62',
  './js/tpl/view-books.js?v=62',
  './js/tpl/view-mock.js?v=62',
  './js/tpl/view-bank.js?v=62',
  './js/tpl/view-stats.js?v=62',
  './js/tpl/view-ingest.js?v=62',
  './js/tpl/view-settings.js?v=62',
  './js/tpl/shell-close.js?v=62',
  './js/app-template.js?v=62',
  './js/app.js?v=62',
