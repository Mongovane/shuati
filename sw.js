...
const CORE = [
  ...
  './css/style.css?v=26',
  './js/constants.js?v=26',
  './js/components/rich-text.js?v=26',
  './js/components/question-card.js?v=26',
  './js/api.js?v=26',
  './js/components/reader.js?v=26',
  './js/views/practice.js?v=26',
  './js/views/bank.js?v=26',
  './js/views/mock-stats.js?v=26',
  './js/views/ingest.js?v=26',
  './js/views/mineru.js?v=26',
  './js/views/books.js?v=26',
  './js/views/settings.js?v=26',
  './js/app-template.js?v=26',
  './js/app.js?v=26',
