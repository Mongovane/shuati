...
const CORE = [
  ...
  './css/style.css?v=10',
  './js/constants.js?v=10',
  './js/components/rich-text.js?v=10',
  './js/components/question-card.js?v=10',
  './js/api.js?v=10',
  './js/components/reader.js?v=10',
  './js/views/practice.js?v=10',
  './js/views/bank.js?v=10',
  './js/views/mock-stats.js?v=10',
  './js/views/ingest.js?v=10',
  './js/views/mineru.js?v=10',
  './js/views/books.js?v=10',
  './js/views/settings.js?v=10',
  './js/app-template.js?v=10',
  './js/app.js?v=10',
