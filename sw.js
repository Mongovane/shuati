...
const CORE = [
  ...
  './css/style.css?v=45',
  './js/constants.js?v=45',
  './js/components/rich-text.js?v=45',
  './js/components/question-card.js?v=45',
  './js/api.js?v=45',
  './js/components/reader.js?v=45',
  './js/views/practice.js?v=45',
  './js/views/bank.js?v=45',
  './js/views/mock-stats.js?v=45',
  './js/views/ingest.js?v=45',
  './js/views/mineru.js?v=45',
  './js/views/books.js?v=45',
  './js/views/settings.js?v=45',
  './js/app-template.js?v=45',
  './js/app.js?v=45',
