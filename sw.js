...
const CORE = [
  ...
  './css/style.css?v=23',
  './js/constants.js?v=23',
  './js/components/rich-text.js?v=23',
  './js/components/question-card.js?v=23',
  './js/api.js?v=23',
  './js/components/reader.js?v=23',
  './js/views/practice.js?v=23',
  './js/views/bank.js?v=23',
  './js/views/mock-stats.js?v=23',
  './js/views/ingest.js?v=23',
  './js/views/mineru.js?v=23',
  './js/views/books.js?v=23',
  './js/views/settings.js?v=23',
  './js/app-template.js?v=23',
  './js/app.js?v=23',
