...
const CORE = [
  ...
  './css/style.css?v=40',
  './js/constants.js?v=40',
  './js/components/rich-text.js?v=40',
  './js/components/question-card.js?v=40',
  './js/api.js?v=40',
  './js/components/reader.js?v=40',
  './js/views/practice.js?v=40',
  './js/views/bank.js?v=40',
  './js/views/mock-stats.js?v=40',
  './js/views/ingest.js?v=40',
  './js/views/mineru.js?v=40',
  './js/views/books.js?v=40',
  './js/views/settings.js?v=40',
  './js/app-template.js?v=40',
  './js/app.js?v=40',
