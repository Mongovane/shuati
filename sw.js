...
const CORE = [
  ...
  './css/style.css?v=53',
  './js/constants.js?v=53',
  './js/components/rich-text.js?v=53',
  './js/components/question-card.js?v=53',
  './js/api.js?v=53',
  './js/components/reader.js?v=53',
  './js/views/practice.js?v=53',
  './js/views/bank.js?v=53',
  './js/views/mock-stats.js?v=53',
  './js/views/ingest.js?v=53',
  './js/views/mineru.js?v=53',
  './js/views/books.js?v=53',
  './js/views/settings.js?v=53',
  './js/tpl/shell-open.js?v=53',
  './js/tpl/view-practice.js?v=53',
  './js/tpl/view-books.js?v=53',
  './js/tpl/view-mock.js?v=53',
  './js/tpl/view-bank.js?v=53',
  './js/tpl/view-stats.js?v=53',
  './js/tpl/view-ingest.js?v=53',
  './js/tpl/view-settings.js?v=53',
  './js/tpl/shell-close.js?v=53',
  './js/app-template.js?v=53',
  './js/app.js?v=53',
