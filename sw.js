...
const CORE = [
  ...
  './css/style.css?v=68',
  './js/constants.js?v=68',
  './js/components/rich-text.js?v=68',
  './js/components/question-card.js?v=68',
  './js/api.js?v=68',
  './js/components/reader.js?v=68',
  './js/views/practice.js?v=68',
  './js/views/bank.js?v=68',
  './js/views/mock-stats.js?v=68',
  './js/views/ingest.js?v=68',
  './js/views/mineru.js?v=68',
  './js/views/books.js?v=68',
  './js/views/settings.js?v=68',
  './js/tpl/shell-open.js?v=68',
  './js/tpl/view-practice.js?v=68',
  './js/tpl/view-books.js?v=68',
  './js/tpl/view-mock.js?v=68',
  './js/tpl/view-bank.js?v=68',
  './js/tpl/view-stats.js?v=68',
  './js/tpl/view-ingest.js?v=68',
  './js/tpl/view-settings.js?v=68',
  './js/tpl/shell-close.js?v=68',
  './js/app-template.js?v=68',
  './js/app.js?v=68',
