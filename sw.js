...
const CORE = [
  ...
  './css/style.css?v=22',
  './js/constants.js?v=22',
  './js/components/rich-text.js?v=22',
  './js/components/question-card.js?v=22',
  './js/api.js?v=22',
  './js/components/reader.js?v=22',
  './js/views/practice.js?v=22',
  './js/views/bank.js?v=22',
  './js/views/mock-stats.js?v=22',
  './js/views/ingest.js?v=22',
  './js/views/mineru.js?v=22',
  './js/views/books.js?v=22',
  './js/views/settings.js?v=22',
  './js/app-template.js?v=22',
  './js/app.js?v=22',
