...
const CORE = [
  ...
  './css/style.css?v=52',
  './js/constants.js?v=52',
  './js/components/rich-text.js?v=52',
  './js/components/question-card.js?v=52',
  './js/api.js?v=52',
  './js/components/reader.js?v=52',
  './js/views/practice.js?v=52',
  './js/views/bank.js?v=52',
  './js/views/mock-stats.js?v=52',
  './js/views/ingest.js?v=52',
  './js/views/mineru.js?v=52',
  './js/views/books.js?v=52',
  './js/views/settings.js?v=52',
  './js/tpl/shell-open.js?v=52',
  './js/tpl/view-practice.js?v=52',
  './js/tpl/view-books.js?v=52',
  './js/tpl/view-mock.js?v=52',
  './js/tpl/view-bank.js?v=52',
  './js/tpl/view-stats.js?v=52',
  './js/tpl/view-ingest.js?v=52',
  './js/tpl/view-settings.js?v=52',
  './js/tpl/shell-close.js?v=52',
  './js/app-template.js?v=52',
  './js/app.js?v=52',
