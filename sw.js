...
const CORE = [
  ...
  './js/components/rich-text.js?v=13',
  './js/components/question-card.js?v=13',
  './js/api.js?v=13',
  './js/components/reader.js?v=13',
  './js/views/practice.js?v=13',
  './js/views/bank.js?v=13',
  './js/views/mock-stats.js?v=13',
  './js/views/ingest.js?v=13',
  './js/views/mineru.js?v=13',
  './js/views/books.js?v=13',
  './js/views/settings.js?v=13',
  './js/app-template.js?v=13',
  './js/app.js?v=13',
