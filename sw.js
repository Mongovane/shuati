...
const CORE = [
  ...
  './css/style.css?v=75',
  './js/constants.js?v=75',
  './js/components/rich-text.js?v=75',
  './js/components/question-card.js?v=75',
  './js/api.js?v=75',
  './js/components/reader.js?v=75',
  './js/views/practice.js?v=75',
  './js/views/bank.js?v=75',
  './js/views/mock-stats.js?v=75',
  './js/views/ingest.js?v=75',
  './js/views/mineru.js?v=75',
  './js/views/books.js?v=75',
  './js/views/settings.js?v=75',
  './js/tpl/shell-open.js?v=75',
  './js/tpl/view-practice.js?v=75',
  './js/tpl/view-books.js?v=75',
  './js/tpl/view-mock.js?v=75',
  './js/tpl/view-bank.js?v=75',
  './js/tpl/view-stats.js?v=75',
  './js/tpl/view-ingest.js?v=75',
  './js/tpl/view-settings.js?v=75',
  './js/tpl/shell-close.js?v=75',
  './js/app-template.js?v=75',
  './js/app.js?v=75',
