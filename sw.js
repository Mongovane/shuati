...
const CORE = [
  ...
  './js/components/rich-text.js?v=17',
  './js/components/question-card.js?v=17',
  './js/api.js?v=17',
  './js/components/reader.js?v=17',
  './js/views/practice.js?v=17',
  './js/views/bank.js?v=17',
  './js/views/mock-stats.js?v=17',
  './js/views/ingest.js?v=17',
  './js/views/mineru.js?v=17',
  './js/views/books.js?v=17',
  './js/views/settings.js?v=17',
  './js/app-template.js?v=17',
  './js/app.js?v=17',
