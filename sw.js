...
const CORE = [
  ...
  './css/style.css?v=63',
  './js/constants.js?v=63',
  './js/components/rich-text.js?v=63',
  './js/components/question-card.js?v=63',
  './js/api.js?v=63',
  './js/components/reader.js?v=63',
  './js/views/practice.js?v=63',
  './js/views/bank.js?v=63',
  './js/views/mock-stats.js?v=63',
  './js/views/ingest.js?v=63',
  './js/views/mineru.js?v=63',
  './js/views/books.js?v=63',
  './js/views/settings.js?v=63',
  './js/tpl/shell-open.js?v=63',
  './js/tpl/view-practice.js?v=63',
  './js/tpl/view-books.js?v=63',
  './js/tpl/view-mock.js?v=63',
  './js/tpl/view-bank.js?v=63',
  './js/tpl/view-stats.js?v=63',
  './js/tpl/view-ingest.js?v=63',
  './js/tpl/view-settings.js?v=63',
  './js/tpl/shell-close.js?v=63',
  './js/app-template.js?v=63',
  './js/app.js?v=63',
