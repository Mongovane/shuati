...
const CORE = [
  ...
  './css/style.css?v=25',
  './js/constants.js?v=25',
  './js/components/rich-text.js?v=25',
  './js/components/question-card.js?v=25',
  './js/api.js?v=25',
  './js/components/reader.js?v=25',
  './js/views/practice.js?v=25',
  './js/views/bank.js?v=25',
  './js/views/mock-stats.js?v=25',
  './js/views/ingest.js?v=25',
  './js/views/mineru.js?v=25',
  './js/views/books.js?v=25',
  './js/views/settings.js?v=25',
  './js/app-template.js?v=25',
  './js/app.js?v=25',
