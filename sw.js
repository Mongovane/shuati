...
const CORE = [
  ...
  './css/style.css?v=93',
  './js/constants.js?v=93',
  './js/components/rich-text.js?v=93',
  './js/components/question-card.js?v=93',
  './js/api.js?v=93',
  './js/components/reader.js?v=93',
  './js/views/practice.js?v=93',
  './js/views/bank.js?v=93',
  './js/views/saved.js?v=93',
  './js/views/mock-stats.js?v=93',
  './js/views/ingest.js?v=93',
  './js/views/mineru.js?v=93',
  './js/views/books.js?v=93',
  './js/views/settings.js?v=93',
  './js/tpl/shell-open.js?v=93',
  './js/tpl/view-practice.js?v=93',
  './js/tpl/view-books.js?v=93',
  './js/tpl/view-mock.js?v=93',
  './js/tpl/view-bank.js?v=93',
  './js/tpl/view-stats.js?v=93',
  './js/tpl/view-ingest.js?v=93',
  './js/tpl/view-settings.js?v=93',
  './js/tpl/shell-close.js?v=93',
  './js/app-template.js?v=93',
  './js/app.js?v=93',
