...
const CORE = [
  ...
  './css/style.css?v=30',
  './js/constants.js?v=30',
  './js/components/rich-text.js?v=30',
  './js/components/question-card.js?v=30',
  './js/api.js?v=30',
  './js/components/reader.js?v=30',
  './js/views/practice.js?v=30',
  './js/views/bank.js?v=30',
  './js/views/mock-stats.js?v=30',
  './js/views/ingest.js?v=30',
  './js/views/mineru.js?v=30',
  './js/views/books.js?v=30',
  './js/views/settings.js?v=30',
  './js/app-template.js?v=30',
  './js/app.js?v=30',
