...
const CORE = [
  ...
  './js/components/rich-text.js?v=14',
  './js/components/question-card.js?v=14',
  './js/api.js?v=14',
  './js/components/reader.js?v=14',
  './js/views/practice.js?v=14',
  './js/views/bank.js?v=14',
  './js/views/mock-stats.js?v=14',
  './js/views/ingest.js?v=14',
  './js/views/mineru.js?v=14',
  './js/views/books.js?v=14',
  './js/views/settings.js?v=14',
  './js/app-template.js?v=14',
  './js/app.js?v=14',
