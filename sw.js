...
const CORE = [
  ...
  './css/style.css?v=76',
  './js/constants.js?v=76',
  './js/components/rich-text.js?v=76',
  './js/components/question-card.js?v=76',
  './js/api.js?v=76',
  './js/components/reader.js?v=76',
  './js/views/practice.js?v=76',
  './js/views/bank.js?v=76',
  './js/views/mock-stats.js?v=76',
  './js/views/ingest.js?v=76',
  './js/views/mineru.js?v=76',
  './js/views/books.js?v=76',
  './js/views/settings.js?v=76',
  './js/tpl/shell-open.js?v=76',
  './js/tpl/view-practice.js?v=76',
  './js/tpl/view-books.js?v=76',
  './js/tpl/view-mock.js?v=76',
  './js/tpl/view-bank.js?v=76',
  './js/tpl/view-stats.js?v=76',
  './js/tpl/view-ingest.js?v=76',
  './js/tpl/view-settings.js?v=76',
  './js/tpl/shell-close.js?v=76',
  './js/app-template.js?v=76',
  './js/app.js?v=76',
