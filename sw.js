...
const CORE = [
  ...
  './css/style.css?v=61',
  './js/constants.js?v=61',
  './js/components/rich-text.js?v=61',
  './js/components/question-card.js?v=61',
  './js/api.js?v=61',
  './js/components/reader.js?v=61',
  './js/views/practice.js?v=61',
  './js/views/bank.js?v=61',
  './js/views/mock-stats.js?v=61',
  './js/views/ingest.js?v=61',
  './js/views/mineru.js?v=61',
  './js/views/books.js?v=61',
  './js/views/settings.js?v=61',
  './js/tpl/shell-open.js?v=61',
  './js/tpl/view-practice.js?v=61',
  './js/tpl/view-books.js?v=61',
  './js/tpl/view-mock.js?v=61',
  './js/tpl/view-bank.js?v=61',
  './js/tpl/view-stats.js?v=61',
  './js/tpl/view-ingest.js?v=61',
  './js/tpl/view-settings.js?v=61',
  './js/tpl/shell-close.js?v=61',
  './js/app-template.js?v=61',
  './js/app.js?v=61',
