...
const CORE = [
  ...
  './css/style.css?v=12',
  './js/constants.js?v=12',
  './js/components/rich-text.js?v=12',
  './js/components/question-card.js?v=12',
  './js/api.js?v=12',
  './js/components/reader.js?v=12',
  './js/views/practice.js?v=12',
  './js/views/bank.js?v=12',
  './js/views/mock-stats.js?v=12',
  './js/views/ingest.js?v=12',
  './js/views/mineru.js?v=12',
  './js/views/books.js?v=12',
  './js/views/settings.js?v=12',
  './js/app-template.js?v=12',
  './js/app.js?v=12',
